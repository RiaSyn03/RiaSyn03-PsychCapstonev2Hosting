...
function build_calendar($month, $year) {
    ...
    while($currentDay <= $numberDays){
        ...
        if($totalbookings==12){
            ...
            $calendar.="<td class='$today'><h4>$currentDay</h4><a href='allstdntbooked'?date=".$date."' class='btn btn-success btn-xs'>Book</a><small><i>$availableslots slots left</i></small></td>";
        }
